...
print_rows([]).
print_rows([Head|Tail]) :- write(Head), nl, print_rows(Tail).
...
% I took the lazy way, a solver for sudokus of arbitrary size would be much
% nicer
sudoku9x9(Puzzle, Solution) :-
	...
	Col3 = [S13, S23, S33, S43, S53, S63, S73, S83, S83],
   ...
   print_rows([Row1, Row2, Row3, Row4, Row5, Row6, Row7, Row8, Row9]).
